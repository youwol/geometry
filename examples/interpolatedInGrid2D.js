...
const dataframe = io.decodeGocadTS( fs.readFileSync('/Users/fmaerten/data/arch/S1/S1.ts', 'utf8') )[0]
...
fs.writeFile('/Users/fmaerten/data/streamlines/interpolated.xyz', buffer, 'utf8', err => {})
